...
module.exports.run = async (bot, message, args) => {
    let replies = [
        ...
        "https://cdn.discordapp.com/attachments/553909813675950092/555124052252164108/tenor_1.gif"
    ];
    ...
    let gifembed = new Discord.EmbedBuilder()
        .setTitle("Kediniz;")
        .setColor("#FF69B4")
        .setFooter({ text: `Kedin ${message.author.tag}`, iconURL: message.author.displayAvatarURL() })
